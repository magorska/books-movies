...
@Route("/v1/movieDb/weekTrending")
public class MovieDbWeekTrendingView extends VerticalLayout {
    ...
    public MovieDbWeekTrendingView() {
    ...
    public void refresh() {
        grid.setItems(movieDbClientService.getWeekTrending());
    }
